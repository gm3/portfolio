  ...
  return (
    <div className="sections">
      ...
      <Section id="about" title="About">
        <p>
          Creative producer and programmer focused on game development and virtual production. I design and ship
          real‑time experiences from prototype to release—blending code, art direction, graphic design, painting,
          and music to build expressive, playable worlds.
        </p>
      </Section>
