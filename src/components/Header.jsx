  ...
  return (
    <header className="header">
      ...
      <nav className={`nav ${menuOpen ? 'open' : ''}`} onClick={() => setMenuOpen(false)}>
        ...
        <a href="https://github.com/gm3" target="_blank" rel="noreferrer" className="icon-btn" aria-label="GitHub">
        ...
        <a href="https://twitter.com/boomboxheads" target="_blank" rel="noreferrer" className="icon-btn" aria-label="Twitter">
